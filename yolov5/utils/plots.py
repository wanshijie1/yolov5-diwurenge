...
# 2025.3.12 添加，目的是为了解决绘制的标签框乱码问题
def put_chinese_text(img, text, org, color, font_size=30):   
    """在图像上绘制中文文本"""
    # 转换为PIL图像
    ...
    # 加载中文字体
    font_path = r"D:/游戏/脚本/yolov5/utils/fonts/SimHei.ttf"  # 字体文件路径，确保SimHei.ttf在项目根目录
    try:
    ...
    # 绘制文本
    draw.text(org, text, font=font, fill=color[::-1])  # PIL使用RGB而不是BGR
