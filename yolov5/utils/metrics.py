...
from matplotlib.font_manager import FontProperties # 2025.3.12 添加，目的：解决matplotlib字体问题
import math
import warnings
...
# 下方代码 2025.3.12 添加，目的：解决matplotlib字体问题
...
class ConfusionMatrix:
    ...
    def process_batch(self, detections, labels):
        """
        Updates confusion matrix based on detections and labels.
        """
    ...
    def plot(self, normalize=True, save_dir="", names=()):
        ...
        ax.set_xlabel("真实类别")  # 修改为中文
        ax.set_ylabel("预测类别")  # 修改为中文
        ax.set_title("混淆矩阵")  # 修改为中文
...
def plot_pr_curve(px, py, ap, save_dir=Path("pr_curve.png"), names=()):
    ...
    ax.set_xlabel("召回率", fontproperties=font)  # 修改为中文
    ax.set_ylabel("精确率", fontproperties=font)  # 修改为中文
    ax.set_xlim(0, 1)
    ax.set_ylim(0, 1)
    ax.legend(bbox_to_anchor=(1.04, 1), loc="upper left", prop=font)  # 设置图例字体
    ax.set_title("精确率-召回率曲线", fontproperties=font)  # 修改为中文
...
def plot_mc_curve(px, py, save_dir=Path("mc_curve.png"), names=(), xlabel="Confidence", ylabel="Metric"):
    ...
    ax.set_xlabel(xlabel, fontproperties=font)  # 修改为中文
    ax.set_ylabel(ylabel, fontproperties=font)  # 修改为中文
    ax.set_xlim(0, 1)
    ax.set_ylim(0, 1)
    ax.legend(bbox_to_anchor=(1.04, 1), loc="upper left", prop=font)  # 设置图例字体
    ax.set_title(f"{ylabel}-置信度曲线", fontproperties=font)  # 修改为中文
    fig.savefig(save_dir, dpi=250)
    plt.close(fig)
