...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.resume and not check_comet_resume(opt) and not opt.evolve:
        ...
        if opt_yaml.is_file():
           #  with open(opt_yaml, errors="ignore") as f:         
            with open(opt_yaml, errors="ignore",encoding='UTF-8') as f:  #   2025.3.12
                d = yaml.safe_load(f)
        else:
    ...
    # Evolve hyperparameters (optional)
        ...
        # with open(opt.hyp, errors="ignore") as f:  # 2025.3.12 该条被注释，下方是新的，强制使用UTF8
        ...
        if opt.resume_evolve is not None:
            ...
            with open(ROOT / opt.resume_evolve, errors="ignore",encoding='UTF-8') as f:    # 2025.3.12
